...
function Section9() {
    ...
    const apiUrl = 'https://obscure-space-cod-q54w6v574v5f9q4q-8080.app.github.dev/api/section9';
    ...
    return (
        <div className="section-container">
            ...
            <h2 className="section-title">Section 9 - Impacted Sites</h2>
