  ...
  return (
    <div
      style={{
        ...
        display: "flex",
        alignItems: "center",
        justifyContent: "space-between", // Align elements
      }}
    >
      {/* Logo */}
      <img
      ...
      {isAuthenticated ? (
        <div style={{
          ...
          flexGrow: 1, // Allows it to expand and push items evenly
        }}>
          <Link to="/" className="nav_btn">Dashboard</Link>
          <Link to="/create-report" className="nav_btn">New Process</Link>
          <Link to="/my-submissions" className="nav_btn">My Drafts</Link>
        </div>
      ) : (
        <h1
          style={{
